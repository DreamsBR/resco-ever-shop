...
export default function Footer() {
  ...
  return (
    <footer className="flex flex-col gap-10 bg-[#95151c] px-10 py-[60px]">
      {/* Main Footer */}
      ...
      <div className="flex items-center justify-between w-full pt-5 border-t border-[#f9f4e130]">
        ...
        <div className="flex gap-6">
          ...
          <a href="/privacy" className="text-[#f9f4e1] font-['Manrope'] text-xs opacity-50 hover:opacity-100 transition-opacity">
