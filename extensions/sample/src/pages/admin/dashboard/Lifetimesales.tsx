...
const Dot = ({ variant }: { variant?: 'info' | 'success' | 'critical' }) => {
  ...
  return (
    <span className={`w-3 h-3 rounded-full ${bgColor} inline-block`} />
  );
};
...
export default function LifetimeSale({ api }: { api: string }) {
