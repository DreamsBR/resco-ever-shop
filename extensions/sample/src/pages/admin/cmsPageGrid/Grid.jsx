  ...
  const actions = [
    {
      ...
      onAction: () => {
        openAlert({
          heading: _('Disable ${count} pages', { count: selectedIds.length.toString() }),
    ...
    },
    {
      ...
      onAction: () => {
        openAlert({
          heading: _('Enable ${count} pages', { count: selectedIds.length.toString() }),
          content: _('Are you sure?'),
          primaryAction: {
            title: _('Cancel'),
            onAction: closeAlert,
    ...
    },
    {
      ...
      onAction: () => {
        openAlert({
          heading: _('Delete ${count} pages', { count: selectedIds.length.toString() }),
