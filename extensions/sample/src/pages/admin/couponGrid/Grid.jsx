  ...
  const actions = [
    {
      ...
      onAction: () => {
        openAlert({
          heading: _('Disable ${count} coupons', { count: selectedIds.length }),
    ...
    },
    {
      ...
      onAction: () => {
        openAlert({
          heading: _('Enable ${count} coupons', { count: selectedIds.length }),
          content: _('Are you sure?'),
          primaryAction: {
            title: _('Cancel'),
            onAction: closeAlert,
    ...
    },
    {
      ...
      onAction: () => {
        openAlert({
          heading: _('Delete ${count} coupons', { count: selectedIds.length }),
